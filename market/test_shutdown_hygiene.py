...
class TestShutdownHygiene(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_graceful_shutdown_prevents_loop_error(
        self, MockExec, MockAsyncSocket, MockSocket, MockShark, mock_getpgid, mock_killpg
    ):
        """
        ...
        # 2. Initialize Runner
        runner = MarketRunner(
            prompt="Shutdown Test", n_agents=1, budget=100.0, api_url="http://127.0.0.1"
        )
