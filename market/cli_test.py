...
class TestCLI(unittest.TestCase):
    ...
    def test_cli_error_json(self):
        ...
        with patch.object(sys, "argv", test_args), patch("sys.stdout", stdout_capture):
    ...
    def test_dashboard_url_dual_output(self, MockRunner):
        ...
        with patch.object(sys, "argv", test_args), patch("sys.stderr", stderr_capture):
        ...
        for line in stdout_out.splitlines():
            try:
                ...
                if data.get(
                    "type"
                ) == "log" and "Dashboard active at http://127.0.0.1:1234" in data.get("message"):
                    found_json = True
            except:
                continue
