...
class TestDoubleSpendBug(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_double_spend_on_verifier_and_beliefs(self):
        ...
        bond_value = sum(
            b.q_shares * orch.state.get_asset_price(b.asset_id)
            for b in orch.state.bonds
        ...
        self.assertGreaterEqual(
            final_liquid_wealth, 0, "Agent's liquid wealth went negative due to double spend!"
        )
