...
describe("Dashboard UI", () => {
    ...
    it("should keep bankrupt agents visible in the traders table with $0", () => {
        ...
        logHandler({
            type: "state", round_num: 2, whale_wealth: 1100, assets: {},
            agents: {}
        });
        ...
        const agentTab = Array.from(document.querySelectorAll('.tab-button')).find(btn => btn.textContent === 'agent_0');
    ...
    it("should update state correctly across multiple rounds", () => {
        ...
        logHandler({
            type: "state", round_num: 1, whale_wealth: 1000, liquidity_b: 100,
        ...
        logHandler({
            type: "state", round_num: 2, whale_wealth: 950, liquidity_b: 100,
        ...
        logHandler({
            type: "state", round_num: 3, whale_wealth: 900, liquidity_b: 100,
            assets: {
